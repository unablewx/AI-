...
import com.model.dto.question.QuestionQueryRequest;
...
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question> implements QuestionService {
    ...
    public void validQuestion(Question question, boolean add) {
        ...
        if (appId != null) {
            ...
            ThrowUtils.throwIf(app == null, ErrorCode.PARAMS_ERROR, "所选应用不存在");
        }
    ...
    public QueryWrapper<Question> getQueryWrapper(QuestionQueryRequest questionQueryRequest) {
        ...
        List<QuestionContentDto> content = questionQueryRequest.getQuestionContent();
        String questionContent = JSONUtil.toJsonStr(content);
