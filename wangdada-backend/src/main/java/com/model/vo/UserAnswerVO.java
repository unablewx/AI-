...
public class UserAnswerVO implements Serializable {
    ...
    public static UserAnswer voToObj(UserAnswerVO userAnswerVO) {
        ...
        List<String> list = userAnswerVO.getChoices();
        userAnswer.setChoices(JSONUtil.toJsonStr(list));
        return userAnswer;
    }
    ...
    public static UserAnswerVO objToVo(UserAnswer userAnswer) {
        ...
        String list = userAnswer.getChoices();
        userAnswerVO.setChoices(JSONUtil.toList(list, String.class));
        return userAnswerVO;
    }
}
