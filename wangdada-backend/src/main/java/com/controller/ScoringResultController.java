...
import com.model.dto.scoreresult.ScoringResultAddRequest;
import com.model.dto.scoreresult.ScoringResultEditRequest;
import com.model.dto.scoreresult.ScoringResultQueryRequest;
import com.model.dto.scoreresult.ScoringResultUpdateRequest;
import com.model.entity.ScoringResult;
import com.model.entity.User;
import com.model.vo.ScoringResultVO;
...
public class ScoringResultController {
    ...
    public BaseResponse<Long> addScoringResult(@RequestBody ScoringResultAddRequest scoringResultAddRequest, HttpServletRequest request) {
        ...
        List<String> prop = scoringResultAddRequest.getResultProp();
        scoringResult.setResultProp(JSONUtil.toJsonStr(prop));
        // 数据校验
    ...
    public BaseResponse<Boolean> updateScoringResult(@RequestBody ScoringResultUpdateRequest scoringResultUpdateRequest) {
        ...
        List<String> prop = scoringResultUpdateRequest.getResultProp();
        scoringResult.setResultProp(JSONUtil.toJsonStr(prop));
        // 数据校验
    ...
    public BaseResponse<Boolean> editScoringResult(@RequestBody ScoringResultEditRequest scoringResultEditRequest, HttpServletRequest request) {
        ...
        List<String> prop = scoringResultEditRequest.getResultProp();
        scoringResult.setResultProp(JSONUtil.toJsonStr(prop));
        // 数据校验
        scoringResultService.validScoringResult(scoringResult, false);
        User loginUser = userService.getLoginUser(request);
